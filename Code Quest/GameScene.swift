...
class GameScene : SKScene {
	...
	func mapToScreenCoordinates(newPos : (Int, Int)) -> CGPoint {
		...
		return CGPoint(x: ViewController.scaleDims(input: ViewController.moveInc * newPos.0 + 45, x: true) , y: Int(self.size.height) -  (ViewController.scaleDims(input: 45 + 64 + ViewController.moveInc * newPos.1, x: false)))
